      ...
      <table class="table-auto w-full text-left whitespace-no-wrap">
        <thead>
          <tr>
            ...
            <th class="md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">Speed</th>
        ...
        <tbody>
          ...
          <tr>
            <td class="md:px-4 py-3">{{ $e_owner->name }}</td>
            <td class="md:px-4 py-3">{{ $e_owner->email }}</td>
            <td class="md:px-4 py-3">{{ $e_owner->created_at->diffForHumans() }}</td>
